...
//  virtual void printComplex(class complex const &c, int minimalFieldWidth=0)=0;
  ...
  virtual void printVectorListList(const IntegerVectorListList &s)=0;
  ...
  virtual void printPolyhedralConeAsFan(class PolyhedralCone const &c);
...
/*  Printer& operator<<(FloatVector const &v)
  ...
  Printer& operator<<(IntegerVectorListList const &l);
...
class LatexPrinter:public Printer
{
 ...
 public:
  ...
  virtual void printVectorListList(const IntegerVectorListList &s);
